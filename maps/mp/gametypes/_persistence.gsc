...
updateweaponbufferedstats()
{
    ...
    if ( var_1[0] == "alt" )
    {
        foreach ( var_3 in var_1 )
        {
            ...
            else if ( getsubstr( var_3, 0, 2 ) == "a#" )
            {
                ...
                else if ( doesattachkitincludebaseattachment( var_4, "gl" ) )
                {
                    var_1[0] = "gl";
                    break;
                }
                ...
                else if ( doesattachkitincludebaseattachment( var_4, "sho" ) )
                {
                    var_1[0] = "sho";
                    break;
                }
    ...
    foreach ( var_8 in var_6 )
    {
        ...
        if ( var_9 == "glmwr" || var_9 == "masterkeymwr" || var_9 == "gl" || var_9 == "sho")
            continue;

        if ( var_9 == "glpremwr" || var_9 == "masterkeypremwr" || var_9 == "glpre" || var_9 == "shopre")
            continue;
