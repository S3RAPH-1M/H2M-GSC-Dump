...
main()
{
    ...
    {
        level.getspawnpoint = ::getspawnpointiw4;
    }

    if( ish1map() )
    {
        level.getspawnpoint = ::getspawnpointh1;
    }
...
onstartgametype()
{
    ...
    if( scripts\mp_patches\common::is_iw4_map() )
    {
        level.globalvariable[0] = "hq";
    }

    if( ish1map() )
    {
        level.globalvariable[0] = "hp";
    }

    maps\mp\gametypes\_gameobjects::main( level.globalvariable );
