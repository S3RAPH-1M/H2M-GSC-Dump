...
ch_hardpoints( var_0 )
{
    ...
    case "counter_radar_mp":
        var_1 processchallenge( "ch_cuav_earned" );
        break; 
    case "airdrop_marker_mp":
        var_1 processchallenge( "ch_carepack_earned" );
        break;
    case "predator_mp":
        var_1 processchallenge( "ch_predator_earned" );
        break;
    case "nuke_mp":
        var_1 processchallenge( "ch_nuke_earned" );
        break;
    case "emp_mp":
        var_1 processchallenge( "ch_emp_earned" );
        break;
    case "airstrike_mp":
    ...
    case "helicopter_mp":
        ...
        break;
    case "pavelow_mp":
        var_1 processchallenge( "ch_pavelow_earned" );
        break;
    case "chopper_gunner_mp":
        var_1 processchallenge( "ch_choppergun_earned" );
        break;
    case "ac130_mp":
        var_1 processchallenge( "ch_ac130_earned" );
        break;
    case "sentry_mp":
        var_1 processchallenge( "ch_sentry_earned" );
        break;
    case "airdrop_mega_marker_mp":
        var_1 processchallenge( "ch_megadrop_earned" );
        break;
    case "harrier_airstrike_mp":
        var_1 processchallenge( "ch_harrier_earned" );
        break;
    case "stealth_airstrike_mp":
        var_1 processchallenge( "ch_stealthstrike_earned" );
        break;
    default:
        break;
    }
...
ch_vehicle_kills( var_0 )
{
    ...
    case "ac130_40mm_mp":
    case "ac130_25mm_mp":
        var_1 processchallenge( "ch_ac130_kills" );
        break;
    case "pavelow_minigun_mp":
        var_1 processchallenge( "ch_pavelow_kills" );
        break;
    case "cobra_player_minigun_mp":
        var_1 processchallenge( "ch_choppergun_kills" );
        break;
    case "stealth_bomb_mp":
        var_1 processchallenge( "ch_stealthstrike_kills" );
        break;
    case "remotemissile_projectile_mp":
        var_1 processchallenge( "ch_predator_kills" );
        break;
    case "sentry_minigun_mp":
        var_1 processchallenge( "ch_sentry_kills" );
        break;
    case "harrier_20mm_mp":
        var_1 processchallenge( "ch_harrier_kills" );
        break;
    case "nuke_mp":
        var_1 processchallenge( "ch_nuke_kills" );
        break;
    default:
        break;
    }
...
ch_kills( var_0 )
{
    ...
    if ( ( var_9 == "MOD_PISTOL_BULLET" || var_9 == "MOD_RIFLE_BULLET" || var_9 == "MOD_HEAD_SHOT" || var_30 == "iw5_m990" ) && !var_13 && !var_12 )
    {
        ...
        if ( isdefined( level.challengeinfo["ch_marksman_" + var_30 + "_2"] ) && var_1 getchallengestatus( "ch_marksman_" + var_30 + "_2" ) > 0 )
            var_1 processchallenge( "ch_marksman_" + var_30 + "_2" );

        if ( isdefined( level.challengeinfo["ch_marksman_" + var_30 + "_3"] ) && var_1 getchallengestatus( "ch_marksman_" + var_30 + "_3" ) > 0 )
            var_1 processchallenge( "ch_marksman_" + var_30 + "_3" );

        if ( isdefined( level.challengeinfo["ch_marksman_" + var_30 + "_4"] ) && var_1 getchallengestatus( "ch_marksman_" + var_30 + "_4" ) > 0 )
            var_1 processchallenge( "ch_marksman_" + var_30 + "_4" );
    ...
    {
        if ( isdefined( var_0.victim.explosiveinfo["damageTime"] ) )
        {
...
processchallenge( baseName, progressInc, forceSetProgress )
{
    ...
    currentProgress = maps\mp\gametypes\_hud_util::ch_getprogress( baseName );
    ...
    else if ( maps\mp\gametypes\_hud_util::isweaponclasschallenge( baseName ) )
    {
        newProgress = currentProgress;
        assertex( newProgress >= currentProgress, "Attempted progress regression (inc) for weapon challenge '" + baseName + "' - from " + currentProgress + " to " + newProgress + " for player " + self.name );
    }
    else
    {
    ...
    for ( var_8 = level.challengeinfo[baseName]["targetval"][missionStatus]; isdefined( var_8 ) && newProgress >= var_8; var_8 = level.challengeinfo[baseName]["targetval"][missionStatus + var_7] )
        var_7++;

    if ( currentProgress < newProgress )
        maps\mp\gametypes\_hud_util::ch_setprogress( baseName, newProgress );
    ...
    if ( var_7 > 0 )
    {
        ...
        while ( var_7 )
        {
            thread giverankxpafterwait( baseName, missionStatus );
            var_10 = getchallengeid( baseName, missionStatus );
            ...
            if ( missionStatus >= level.challengeinfo[baseName]["targetval"].size && level.challengeinfo[baseName]["parent_challenge"] != "" )
                processchallenge( level.challengeinfo[baseName]["parent_challenge"] );
        ...
        if ( !issubstr( baseName, "ch_limited_bloodshed" ) )
            thread maps\mp\gametypes\_hud_message::challengesplashnotify( baseName, var_9, missionStatus );

        maps\mp\gametypes\_hud_util::ch_setstate( baseName, missionStatus );
...
isweaponchallenge( var_0 )
{
    ...
    for ( var_3 = 0; var_3 < var_2.size; var_3++ )
    {
        ...
        if ( var_4 == "iw5" || var_4 == "iw6" || var_4 == "h1" || var_4 == "h2")
...
getweaponfromchallenge( var_0 )
{
    ...
    if ( var_3[0] == "iw5" || var_3[0] == "iw6" || var_3[0] == "h1" || var_3[0] == "h2")
