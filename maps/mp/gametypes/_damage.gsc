...
h2_killstreakLifeId( attacker, eInflictor, sWeapon )
{
    ...
    case "cobra_player_minigun_mp":
        return ( attacker.heliRideLifeId == attacker.pers["deaths"] );
    ...
    case "dogs_mp":
        ...
        return ( killstreakLifeId == attacker.pers["deaths"] );
...
{
    var_0 maps\mp\_events::checkstreakingevents( var_1 );
...
handlenormaldeath( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( level.killstreak_kills && h2_killstreakLifeId( var_1, var_2, var_3 ) )
...
dofinalkillcam()
{
    ...
    foreach ( var_20 in level.players )
    {
        ...
        if( var_20 maps\mp\_utility::isEMPed() )
            var_20 maps\mp\h2_killstreaks\_emp::_setEMPJammed( false );
...
callback_playerlaststand( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    else
    {
        ...
        else
        {
            ...
            var_11.iconname = level.specialty_laststand_icon;
        }
...
handlelaststandweaponsmwr( var_0 )
{
    ...
    {
        if ( maps\mp\gametypes\_class::isvalidoffhand( var_5 ) && (var_1 || allowoffhand) )
            continue;

        if ( maps\mp\gametypes\_class::isvalidequipment( var_5 ) && (var_2 || allowoffhand) )
            continue;
...
reviveholdthink( var_0, useTime, var_2 )
{
    var_3 = 3000;
...
logprintplayerdeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    logprint( "K;" + var_10 + ";" + var_7 + ";" + var_9 + ";" + sanitise_name( var_8 ) + ";" + var_11 + ";" + var_14 + ";" + var_13 + ";" + sanitise_name( var_12 ) + ";" + var_4 + ";" + var_2 + ";" + var_3 + ";" + var_6 + "\n" );
}
