...
killedplayerevent( var_0, var_1, var_2 )
{
    ...
    case "pavelow_minigun_mp":
        var_3 = "pavelow_mp_kill";
        break;
    case "cobra_player_minigun_mp":
        var_3 = "chopper_gunner_mp_kill";
        break;
    case "stealth_bomb_mp":
        var_3 = "stealth_airstrike_mp_kill";
        break;
    case "remotemissile_projectile_mp":
        var_3 = "predator_mp_kill";
        break;
    case "sentry_minigun_mp":
        var_3 = "sentry_mp_kill";
        break;
    case "harrier_20mm_mp":
        var_3 = "harrier_mp_kill";
        break;
    case "nuke_mp":
        var_3 = "nuke_mp_kill";
        break;
    ...
    if( !isDefined(level.xpeventinfo[var_3]) || !isDefined( level.xpeventinfo[var_3]["value"] ) )
        var_3 = "kill";
