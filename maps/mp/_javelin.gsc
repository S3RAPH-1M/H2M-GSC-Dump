...
ResetJavelinLocking()
{
	...
	self setclientomnvar( "ui_javelin_lock_status", 0 );
...
EyeTraceForward()
{
	...
	if ( IsDefined( ent ) )
	{
		if ( isDefined(level.ac130player) && ent == level.ac130.planeModel )
			return undefined;
	}
...
JavelinUsageLoop()
{
	...
	self setclientomnvar( "ui_javelin", 1 );
...
#/
			...
			self setclientomnvar( "ui_javelin_lock_status", 1 );
...
#/
			...
			self.javelinStage = 3;
			self setclientomnvar( "ui_javelin_lock_status", 2 );
		}
